...
def main(dataset, dataset_setting, spurious_ratio, demean, pca, k_components, alpha, null_is_concept, batch_size, solver, lr,weight_decay,  early_stopping, epochs,balanced_training_concept, balanced_training_main, baseline_adjust,  per_step, device_type, save_results, seed, folder, delta, use_training_data_for_testing=False, eval_balanced=True, use_standard_ERM_settings_after=True, concept_first=True, remove_concept=True, use_smaller_set = False, n_for_estimation='all', single_finetuned_model=False):
    ...
    V_c, V_m, d_c, d_m = train_JSE(data_obj,
                                                        ...
                                                        alpha=alpha,
                                                         ...
                                                         model_base_name='JSE_'+dataset+'_'+str(seed)+'_',
    ...
    if use_smaller_set:
        ...
        data_obj.y_c_train = y_c_train
        data_obj.y_c_val = y_c_val
    ...
    main_model = return_linear_model(d, 
                                              ...
                                              bias=True,
                                              weight_decay=weight_decay, 
                                              model_name=dataset+'_main_model_after_JSE_'+str(seed),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_smaller_set", type=str, default="False", help="whether to use val set")
    parser.add_argument("--n_for_estimation", type=str, default="all", help="whether to use val set")
    ...
    main(dataset, dataset_setting, spurious_ratio, demean, pca, k_components, alpha, null_is_concept, batch_size, solver, lr,weight_decay,  early_stopping, epochs,balanced_training_concept,balanced_training_main, baseline_adjust, per_step, device_type, save_results, seed, folder, delta, eval_balanced=eval_balanced, concept_first=concept_first, remove_concept=remove_concept, use_smaller_set=use_smaller_set, n_for_estimation=n_for_estimation, single_finetuned_model=single_finetuned_model)
