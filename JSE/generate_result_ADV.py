...
def main(dataset, dataset_setting, spurious_ratio, demean, pca, k_components, alpha,  batch_size, solver, lr,weight_decay,  early_stopping, epochs, balanced_training_main,  per_step, device_type, save_results, seed, folder, use_standard_ERM_settings_after = True, single_finetuned_model=False):
    ...
    # get the data obj
    set_seed(seed)
    data_obj = get_dataset_obj(dataset, dataset_settings, spurious_ratio, data_info, seed, device, use_punctuation_MNLI=True, single_model_for_embeddings=single_finetuned_model, adversarial=True   )
...
if __name__ == "__main__":
    ...
    main(dataset, dataset_setting, spurious_ratio, demean, pca, k_components,  alpha,  batch_size, solver, lr,weight_decay,  early_stopping, epochs, balanced_training_main,  per_step, device_type, save_results, seed, folder, single_finetuned_model=single_finetuned_model)
