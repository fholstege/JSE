...
def main(finetuned_BERT, settings, train_size, val_size, spurious_ratio_train,spurious_ratio_sample, embedding_type, binary_task, dropout,  device,use_punctuation,  seed_list,early_stopping=True, finetune_mode='CLS', seed_data=1971 ):
    ...
    for seed in seed_list:
        ...
        if finetuned_BERT:
            ...
            print('the finetune file is: ', finetuned_file_name)
            if use_punctuation:
        ...
        if train_size =='all':
            ...
            if finetuned_BERT:
                ...
                filename = 'finetuned_models/sample_ids_MNLI_settings_{}_train_size_{}_val_size_{}_spurious_ratio_{}_binary_{}_dropout_{}_early_stopping_{}_finetune_mode_{}_seed_{}'.format( settings, train_size, val_size, int(100*spurious_ratio_sample), int(binary_task),int(100*dropout), int(early_stopping), finetune_mode, seed_data)
                if use_punctuation:
