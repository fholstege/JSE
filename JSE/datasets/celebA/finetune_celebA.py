...
def main(dataset_setting, settings, spurious_ratio,balance_main, early_stopping, adversarial, per_step, start_seed, sims, device_type='mps', balance_concept=False):
    ...
    for sim_i in range(sims):
        ...
        dataset_settings = data_info['celebA'][dataset_setting]
        ...
        if settings == 'adversarial_param' or 'kirichenko':
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_setting')
    ...
    main(dataset_setting, settings, spurious_ratio,balance_main, early_stopping, adversarial,per_step, seed, sims)
